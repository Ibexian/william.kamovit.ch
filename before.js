...
function ab(a) {
 ...
 a = c[154] | 0;
 if ((a | 0) != 0 ? (t = c[152] | 0, y = t + l | 0, y >>> 0 <= t >>> 0 | y >>> 0 > a >>> 0) : 0) {
  M = 0;
  return M | 0;
 }
 d : do if (!(c[155] & 4)) {
  ...
  f : do if ((v | 0) == 184) {
   g = 0 - d | 0;
   do if (j >>> 0 > d >>> 0 & (d >>> 0 < 2147483647 & (f | 0) != (-1 | 0)) ? (u = c[164] | 0, u = k - d + u & 0 - u, u >>> 0 < 2147483647) : 0) if ((ma(u | 0) | 0) == (-1 | 0)) {
    ma(g | 0) | 0;
    break f;
   } else {
    d = u + d | 0;
...
function Wa(b, d, e) {
 ...
 a : do if ((h | 0) == 4) {
  ...
  b : do if ((a[e + 75 >> 0] | 0) > -1) {
   ...
   if ((ya[c[e + 36 >> 2] & 3](e, b, f) | 0) >>> 0 < f >>> 0) break a;
   d = d - f | 0;
   b = b + f | 0;
   g = c[i >> 2] | 0;
  } else {
...
function Oa(b, e) {
 ...
 do if ((j | 0) == 4) {
  ...
  if ((ya[c[b + 36 >> 2] & 3](b, l, 1) | 0) == 1) f = d[l >> 0] | 0; else f = -1;
 } while (0);
 i = m;
 return f | 0;
}
...
function Ua(a) {
 ...
 do if (a) {
  ...
  if (!(c[14] | 0)) b = 0; else b = Ua(c[14] | 0) | 0;
  ia(36);
  a = c[8] | 0;
  if (a) do {
   if ((c[a + 76 >> 2] | 0) > -1) d = Ma(a) | 0; else d = 0;
   if ((c[a + 20 >> 2] | 0) >>> 0 > (c[a + 28 >> 2] | 0) >>> 0) b = $a(a) | 0 | b;
   if (d) Na(a);
   a = c[a + 56 >> 2] | 0;
  } while ((a | 0) != 0);
  ra(36);
...
function $a(a) {
 ...
 b = a + 20 | 0;
 g = a + 28 | 0;
 if ((c[b >> 2] | 0) >>> 0 > (c[g >> 2] | 0) >>> 0 ? (ya[c[a + 36 >> 2] & 3](a, 0, 0) | 0, (c[b >> 2] | 0) == 0) : 0) b = -1; else {
  h = a + 4 | 0;
  d = c[h >> 2] | 0;
  e = a + 8 | 0;
  f = c[e >> 2] | 0;
  if (d >>> 0 < f >>> 0) ya[c[a + 40 >> 2] & 3](a, d - f | 0, 1) | 0;
  c[a + 16 >> 2] = 0;
  c[g >> 2] = 0;
  c[b >> 2] = 0;
  c[e >> 2] = 0;
...
function Ya(b) {
 ...
 var d = 0, e = 0, f = 0, g = 0;
 f = c[13] | 0;
 if ((c[f + 76 >> 2] | 0) > -1) g = Ma(f) | 0; else g = 0;
 do if ((Va(b, f) | 0) < 0) d = 1; else {
...
function Sa(b, d, e) {
 ...
 f = g;
 c[b + 36 >> 2] = 3;
 if ((c[b >> 2] & 64 | 0) == 0 ? (c[f >> 2] = c[b + 60 >> 2], c[f + 4 >> 2] = 21505, c[f + 8 >> 2] = g + 12, (qa(54, f | 0) | 0) != 0) : 0) a[b + 75 >> 0] = -1;
 f = Ra(b, d, e) | 0;
 i = g;
 return f | 0;
}
...
function Ka() {
 var a = 0;
 if (!(c[2] | 0)) a = 60; else a = c[(ga() | 0) + 60 >> 2] | 0;
 return a | 0;
}
function Aa(a) {
 a = a | 0;
...
var xa=[ib,Pa];var ya=[jb,Sa,Qa,Ra];var za=[kb,_a];return{_free:bb,_main:Ja,_memset:db,_malloc:ab,_memcpy:eb,_fflush:Ua,___errno_location:Ka,runPostSets:cb,stackAlloc:Aa,stackSave:Ba,stackRestore:Ca,establishStackSpace:Da,setThrew:Ea,setTempRet0:Ha,getTempRet0:Ia,dynCall_ii:fb,dynCall_iiii:gb,dynCall_vi:hb}})
